                        ...
                        <table   id="coupon_report" class="table  table-striped table-bordered dttablewidth">
                           <thead>
                              <tr>
                                 ...
                                 <th style="vertical-align: top;">{{__('messages.coupon')}} {{__('messages.code')}}</th>
                                 <th style="vertical-align: top;">{{__('messages.coupon')}} {{__('messages.name')}}</th>
                                 <th style="vertical-align: top;">{{__('messages.orders')}}</th>
