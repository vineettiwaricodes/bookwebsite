        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    @endif
                    <div class="row mrg30">
                        <form action="{{url('admin/addbestsellerproduct')}}" method="post">
                            {{csrf_field()}}
                        ...
                        <div class="col-md-6 col-sm-6 col-12 float-right-1">
                            <button onclick="addcatlog()" class="btn btn-primary fea">Add BestSeller</button>
                        </div>
                        
                    </div>
                    <div id="tableview">
                        <div class="table-responsive dtdiv">
                            <table id="bestsellertable" class="table table-striped table-bordered dttablewidth">
                                <thead>
                                    <tr>
