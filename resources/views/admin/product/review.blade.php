                  ...
                  <table id="productreviewTable" class="table table-striped table-bordered dttablewidth">
                     <thead>
                        <tr>
                           ...
                           <th style="vertical-align: top;">{{__('messages.product_name')}}</th>
                           <th style="vertical-align: top;">{{__('messages.review_name')}}</th>
                           <th style="vertical-align: top;">{{__('messages.ratting')}}</th>
                           <th style="vertical-align: top;">{{__('messages.review')}}</th>
