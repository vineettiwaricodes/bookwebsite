                           ...
                           <div class="custom-tab">
                              <nav class="col-md-12 tabcatlog">
                                 <div class="nav nav-tabs tabdiv" id="nav-tab" role="tablist">
                                    ...
                                    <a class="nav-item nav-link <?= $tab==3?"active":"tabdiv" ?>" id="custom-nav-vender-tab" data-toggle="tab" href="#custom-nav-vender" role="tab" aria-controls="custom-nav-vender" aria-selected="false">{{__('messages.vender')}}</a>
                                    <a class="nav-item nav-link <?= $tab==4?"active":"tabdiv" ?>" id="custom-nav-shipping-tab" data-toggle="tab" href="#custom-nav-shipping" role="tab" aria-controls="custom-nav-shipping" aria-selected="false">{{__('Shipping Cost')}}</a>
                                    <a class="nav-item nav-link <?= $tab==5?"active":"tabdiv" ?>" id="custom-nav-delivery-tab" data-toggle="tab" href="#custom-nav-delivery" role="tab" aria-controls="custom-nav-delivery" aria-selected="false">{{__('Delivery Days')}}</a>
                                    <a class="nav-item nav-link <?= $tab==6?"active":"tabdiv" ?>" id="custom-nav-inventory-tab" data-toggle="tab" href="#custom-nav-inventory" role="tab" aria-controls="custom-nav-inventory" aria-selected="false">{{__('messages.inventory')}}</a>
                                    <a class="nav-item nav-link <?= $tab==7?"active":"tabdiv" ?>" id="custom-nav-imgls-tab" data-toggle="tab" href="#custom-nav-imgls" role="tab" aria-controls="custom-nav-imgls" aria-selected="false">{{__('messages.images')}}</a>
                                    <a class="nav-item nav-link <?= $tab==8?"active":"tabdiv" ?>" id="custom-nav-attribute-tab" data-toggle="tab" href="#custom-nav-attribute" role="tab" aria-controls="custom-nav-attribute" aria-selected="true">{{__('messages.attribute')}}</a>
                                    <a class="nav-item nav-link <?= $tab==9?"active":"tabdiv" ?>" id="custom-nav-option-tab" data-toggle="tab" href="#custom-nav-option" role="tab" aria-controls="custom-nav-option" aria-selected="false">{{__('messages.option')}}</a>
                                    <a class="nav-item nav-link tabdiv <?= $tab==10?"active":"tabdiv" ?>" id="custom-nav-rel_pro-tab" data-toggle="tab" href="#custom-nav-rel_pro" role="tab" aria-controls="custom-nav-rel_pro" aria-selected="false">{{__('messages.realted_product')}}</a>     
                                 </div>
                              </nav>
                              <div class="tab-content col-md-12 p-0 " id="nav-tabContent">
                                 <div class="tab-pane fade <?= $tab==1?"show active":"" ?> pd10" id="custom-nav-general" role="tabpanel" aria-labelledby="custom-nav-general-tab" >
                                    ...
                                    <form action="{{url('admin/saveproduct')}}" method="post">
                                       ...
                                       <div class="row">
                                          ...
                                          <div class="form-group col-md-4">
                                             <label for="subcategory" class="control-label mb-1">{{__('messages.sub_cat')}}
                                             </label>
                                             <select name="subcategory" id="subcategory" class="form-control" onchange="getbrand(this.value)">
                                          ...
                                          <div class="form-group  col-md-4" >
                                             <label for="brand" class="control-label mb-1">{{__('messages.brands')}}
                                             </label>
                                          ...
                                          <div class="form-group col-md-6" >
                                             <label for="brand" class="control-label mb-1">{{__('Author')}}<span class="reqfield">*</span>
                                             </label>
                                             <input type="text" name="author" id="colorname"  value="<?= isset($data->author)?$data->author:""?>" value="" class=" form-control" required>
                                          </div>
                                          <!-- <div class="form-group col-md-6" >
                                             <label for="brand" class="control-label mb-1">{{__('Language')}}<span class="reqfield">*</span>
                                             </label>
                                             <input type="text" name="language" id="colorname"  value="<?= isset($data->language)?$data->language:""?>" value="" class=" form-control" >
                                          </div> -->
                                          <div class="form-group col-md-6" >
                                             <label for="brand" class="control-label mb-1">{{__('Publisher')}}<span class="reqfield">*</span>
                                             </label>
                                             <input type="text" name="publisher" id="colorname"  value="<?= isset($data->publisher)?$data->publisher:""?>" value="" class=" form-control" required>
                                          </div>
                                          <div class="form-group col-md-6" >
                                             <label for="brand" class="control-label mb-1">{{__('ISBN')}}<span class="reqfield">*</span>
                                             </label>
                                             <input type="text" name="isbn" id="colorname"  value="<?= isset($data->isbn)?$data->isbn:""?>" value="" class=" form-control" required>
                                          </div>
                                          <div class="form-group col-md-6" >
                                             <label for="brand" class="control-label mb-1">{{__('Binding')}}<span class="reqfield">*</span>
                                             </label>
                                             <select class="form-control" name="binding" id="texable" required>
                                          ...
                                          <div class="form-group col-md-6" >
                                             <label for="brand" class="control-label mb-1">{{__('Publishing Date')}}<span class="reqfield">*</span>
                                             </label>
                                             <input type="date" name="publish_date" id="colorname"  value="<?= isset($data->publish_date)?$data->publish_date:""?>" value="" class=" form-control" required>
                                          </div>
                                          <div class="form-group col-md-6" >
                                             <label for="brand" class="control-label mb-1">{{__('Weight')}}<span class="reqfield">*</span>
                                             </label>
                                             <input type="text" name="weight" id="colorname"  value="<?= isset($data->weight)?$data->weight:""?>" value="" class=" form-control" required>
                                          </div>
                                          <div class="form-group col-md-6" >
                                             <label for="brand" class="control-label mb-1">{{__('Product Edition')}}<span class="reqfield">*</span>
                                             </label>
                                             <input type="text" name="product_edition" id="colorname"  value="<?= isset($data->product_edition)?$data->product_edition:""?>" value="" class=" form-control" required>
                                          </div>
                                          <div class="form-group col-md-6" >
                                             <label for="brand" class="control-label mb-1">{{__('Language')}}<span class="reqfield">*</span>
                                             </label>
                                          ...
                                          <div class="form-group col-md-6" >
                                             <label for="brand" class="control-label mb-1">{{__('Dimension(H-L-W)')}}
                                             </label>
                                             <input type="text" name="dimension" id="dimension"  value="<?= isset($data->dimension)?$data->dimension:""?>" value="" class=" form-control" >
                                          </div>

                                          <div class="form-group col-md-6" >
                                             <label for="brand" class="control-label mb-1">{{__('Print On demand?')}}<span class="reqfield">*</span>
                                             </label>
                                 ...
                                 <div class="tab-pane fade <?= $tab==3?"show active":"" ?> pd10" id="custom-nav-vender" role="tabpanel" aria-labelledby="custom-nav-vender-tab" >
                                    <h3>{{__('messages.vender')}}</h3>
                                    <div class="tabdivcatlog"></div>
                                    <form action="{{url('admin/savevendername')}}" method="post">
                                       {{csrf_field()}}
                                       <input type="hidden" name="product_id" id="product1" value
                                       ="{{$product_id}}"/>
                                       <div class="form-group">
                                          ...
                                          <input id="vender_name" name="vender_name" value="<?= isset($data->vender_name)?$data->vender_name:""?>" type="text" class="form-control" aria-required="true" aria-invalid="false" placeholder="{{__('messages.name')}}">
                                       </div>
                                       <div class="row form-group rowset">
                                          <button class="btn btn-primary btn-flat m-b-30 m-t-30 florig" type="submit">{{__('messages.save')}}</button>
                                       </div>
                                    </form>
                                 </div>

                                 <div class="tab-pane fade <?= $tab==4?"show active":"" ?> pd10" id="custom-nav-shipping" role="tabpanel" aria-labelledby="custom-nav-shipping-tab" >
                                    <h3>{{__('Shipping Cost')}}</h3>
                                    <div class="tabdivcatlog"></div>
                                    <form action="{{url('admin/saveshippingcharges')}}" method="post">
                                       {{csrf_field()}}
                                       <input type="hidden" name="product_id" id="product1" value
                                       ="{{$product_id}}"/>
                                       <div class="form-group">
                                          <label for="name" class="control-label mb-1">{{__('Shipping Charges')}}<span class="reqfield">*</span>
                                          </label>
                                          <input id="shipping_charges" name="shipping_charges" value="<?= isset($data->shipping_charges)?$data->shipping_charges:""?>" type="text" class="form-control" aria-required="true" aria-invalid="false" placeholder="{{__('shipping charges')}}" required>
                                       </div>
                                       <div class="row form-group rowset">
                                          <button class="btn btn-primary btn-flat m-b-30 m-t-30 florig" type="submit">{{__('messages.save')}}</button>
                                       </div>
                                 ...
                                 <div class="tab-pane fade <?= $tab==5?"show active":"" ?> pd10" id="custom-nav-delivery" role="tabpanel" aria-labelledby="custom-nav-delivery-tab" >
                                    <h3>{{__('Delivery Charges')}}</h3>
                                    <div class="tabdivcatlog"></div>
                                    <form action="{{url('admin/savedeliverycharges')}}" method="post">
                                       {{csrf_field()}}
                                       <input type="hidden" name="product_id" id="product1" value
                                       ="{{$product_id}}"/>
                                       <div class="form-group">
                                          <label for="name" class="control-label mb-1">{{__('Delivery Days')}}<span class="reqfield">*</span>
                                          </label>
                                          <input id="delivery_days" name="delivery_days" value="<?= isset($data->delivery_days)?$data->delivery_days:""?>" type="text" class="form-control" aria-required="true" aria-invalid="false" placeholder="{{__('delivery charges')}}" required>
                                       </div>
                                       <div class="row form-group rowset">
                                          <button class="btn btn-primary btn-flat m-b-30 m-t-30 florig" type="submit">{{__('messages.save')}}</button>
                                       </div>
                                 ...
                                 <div class="tab-pane fade <?= $tab==6?"show active":"" ?> pd10" id="custom-nav-inventory" role="tabpanel" aria-labelledby="custom-nav-inventory-tab">
                                    ...
                                    <form action="{{url('admin/saveinventory')}}" method='post'>
                                       ...
                                       <div class="row">
                                          <div class="form-group col-md-4">
                                             <label for="name" class="control-label mb-1">{{__('messages.SKU')}}<span class="reqfield">*</span></label>
                                             <input id="sku" name="sku" type="text" value="<?= isset($data->sku)?$data->sku:""?>" class="form-control" aria-invalid="false" placeholder="{{__('messages.SKU')}}" required>
                                          </div>
                                          <div class="form-group col-md-4">
                                             <label for="name" class="control-label mb-1">{{__('Quantity')}}</label>
                                             <input id="sku" name="quantity" type="number" value="<?= isset($data->quantity)?$data->quantity:""?>" class="form-control" aria-invalid="false" placeholder="{{__('Quantity')}}">
                                          </div>
                                          <div class="form-group col-md-4">
                                 ...
                                 <div class="tab-pane fade <?= $tab==7?"show active":"" ?> pd10" id="custom-nav-imgls" role="tabpanel" aria-labelledby="custom-nav-imgls-tab">
                                 ...
                                 <div class="tab-pane fade <?= $tab==8?"show active":"" ?>  pd10" id="custom-nav-attribute" role="tabpanel" aria-labelledby="custom-nav-attribute-tab">
                                 ...
                                 <div class="tab-pane fade <?= $tab==9?"show active":"" ?> pd10" id="custom-nav-option" role="tabpanel" aria-labelledby="custom-nav-option-tab">
                                    <h3>{{__('messages.option')}}</h3>
                                    <div class="tabdivcatlog"></div>
                                    @include('admin.product.optionadd')
                                 </div>
                                 <div class="tab-pane fade <?= $tab==10?"show active":"" ?> pd10" id="custom-nav-rel_pro" role="tabpanel" aria-labelledby="custom-nav-rel_pro-tab">
