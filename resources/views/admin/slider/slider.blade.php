                ...
                <div class="col-lg-12 ban col-md-12">
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="card">
                            ...
                            <form id="imageUploadForm" action="{{url('admin/addslider')}}" enctype="multipart/form-data" method="post">
                                {{csrf_field()}}
                                <div class="card-body">
                  ...
                  <table  class="table table-striped table-bordered dttablewidth">
                     ...
                     @foreach ($Slider as $cd)
                        ...
                        <td>{{ $cd->urllink }}</td>
                         ...
                         <td>{{ $cd->created_at}}</td>
                         <td><a onclick="return confirm('Are you sure?')" href='delete/{{ $cd->id }}'> <i class="fa fa-trash f-s-25" style="font-size: x-large; "></i> </a>
                          <a   onclick="return confirm('Are you sure?')" href='edit_right/{{ $cd->id }}'> <i class="fa fa-edit f-s-25" style="font-size: x-large;"></i> </a></td>
