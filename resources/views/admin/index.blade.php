...
<html class="no-js" lang="en">
   <head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
      ...
      <link rel="shortcut icon" href="{{asset('public/webpages/assets/image/favicon.png')}}">
      ...
      <aside id="left-panel" class="left-panel">
         <nav class="navbar navbar-expand-sm navbar-default">
            <div class="navbar-header">
               ...
               <!-- <img src="{{asset('public/admin/images/albamartnew.png')}}" alt="" style="width: 100px;">  -->
               </a>
                 ...
                 @endif
                  ...
                  <li class="menu-item-has-children dropdown">
                     ...
                     <ul class="sub-menu children dropdown-menu">
                        ...
                        <li>
                        <a href="{{url('admin/promobanner')}}">
                           {{__('Promotion Section')}}
                           </a>
                           ...
                           <li>
                           <a href="{{url('admin/showslider')}}">
                           {{__('messages.slider')}}
                           </a>
                           </li>
                        <li> 
                           <a href="{{url('admin/showslider2')}}">
                           {{__('messages.sliderL')}}
                           </a> 
                           </li> 
                           <!-----
                  ...
                  <li class="active">
                     <a href="{{url('admin/author')}}"  aria-haspopup="true" aria-expanded="false"> 
                         <i class="menu-icon  fa fa-dollar"></i>
                         {{__('Add Author')}}
                     </a>                     
                  </li> 
                  <li class="active">
                     <a href="{{url('admin/publisher')}}"  aria-haspopup="true" aria-expanded="false"> 
                         <i class="menu-icon  fa fa-dollar"></i>
                         {{__('Add Publisher')}}
                     </a>                     
                  </li>
                  ...
                  <li class="active">
                     <a href="{{url('admin/report')}}"  aria-haspopup="true" aria-expanded="false" >
  ...
  <div class="dropdown-menu" aria-labelledby="bell-button" id="notificationshow">
   <p class="red" id="notificationmsg">{{__('messages.orders_pending')}}</p>
      ...
      <script type="text/javascript" src="{{asset('public/js/admin.js').'?v=32423432'}}"></script>
