   ...
   <div class="col-12">
      <div class="card">
         <div class="card-body">
            ...
            @endif
            <button  data-toggle="modal" data-target="#adduser" class="btn btn-primary btn-flat m-b-30 m-t-30" >{{__('messages.add')}} {{__('messages.users')}}</button>
               ...
               <table id="userTable" class="table table-striped table-bordered dttablewidth">
                  <thead>
                     <tr>
                        ...
                        <th style="vertical-align: top;">{{__('messages.name')}}</th>
                        <th style="vertical-align: top;">{{__('messages.email')}}</th>
                        <th style="vertical-align: top;">{{__('messages.phone')}}</th>
                        <th style="vertical-align: top;">{{__('Order')}}</th>
                        <th style="vertical-align: top;">{{__('User type')}}</th>
   ...
   <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
         <div class="modal-header">
            <h5 class="modal-title" id="smallmodalLabel">{{__('messages.add')}} {{__('messages.users')}}</h5>
         ...
         <form action="{{url('admin/adduser')}}" method="post">
            ...
            <div class="modal-body">
               <div class="form-group col-md-12 paddiv">
                  <div class="col-md-12">
                     <label for="cc-payment" class="control-label mb-1">{{__('messages.first_name')}}<span class="reqfield">*</span></label>
               ...
               <div class="form-group col-md-12 paddiv">
                  <div class="col-md-6">
                     ...
                     <input id="email" name="email" type="text" class="form-control" required placeholder="{{__('messages.email')}}">
                  </div>
                  <div class="col-md-6">
                     <label for="cc-payment" class="control-label mb-1">{{__('messages.phone')}}</label>
                     <input id="phone" name="phone" type="text" class="form-control"  placeholder="{{__('messages.phone')}}">
                  </div>
               </div>
         ...
         <form action="{{url('admin/updateuser')}}" method="post">
            ...
            <div class="modal-body">
               ...
               <div class="form-group col-md-12 paddiv">
                  ...
                  <div class="col-md-6">
                     <label for="cc-payment" class="control-label mb-1">{{__('messages.phone')}}</label>
                     <input id="edit_phone" name="phone" type="text" class="form-control"  placeholder="{{__('messages.phone')}}">
                  </div>
               </div>
               <div class="form-group col-md-12">
                  <label for="cc-payment" class="control-label mb-1">{{__('messages.address')}}</label>
