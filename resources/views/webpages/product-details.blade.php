       ...
       <h6 class="chi_heading">ADD TO CART</h6></button>
                    ...
                    <div class="single-slide">
                        <div  class="product-card">
                            ...
                            <div class="product-card--body">
                                <div class="card-image">
                                    <img class="image_size" src="{{asset('public/webpages/assets/image/products/product-2.jpg')}}" alt=""><br>
                ...
                {"breakpoint":320, "settings": {"slidesToShow": 2} }
                    ...
                    <div  class="single-slide">
                        <div  class="product-card">
                            ...
                            <div class="product-card--body">
                                <div class="card-image">
                                    <img class="image_size" src="{{asset('public/webpages/assets/image/products/sachin.jpg')}}" alt=""><br>
