                        ...
                        "asNavFor": ".product-slider-nav"
                                    ...
                                    <div class="single-slide">
                                        <!-- <img src="{{asset('public/webpages/assets/image/products/product-details-1.jpg')}}"
                                            ...
                                            <img src="{{url('public/upload/product/'.$productdetail[0]->basic_image)}} " alt="image" >
                                    </div>
                                    <div class="single-slide">
                                        <img src="{{url('public/upload/product/'.$productdetail[0]->additional_image)}}"
                    ...
                    <div class="col-lg-7">
                        <div class="product-details-info w-100 h-100">
                            ...
                            <div class="border-bottom">
                                <h3 class="product-title mt-2 mb-1">{{$productdetail[0]->name}}</h3>
                                <p class=" mb-1">by {{$productdetail[0]->author}} (Author),{{$productdetail[0]->publisher}} (Publisher)</p>
                                ...
                                <div class="col-md-7 border-right border-bottom">
                                    ...
                                    <div class="row">
                                        <div class="col-12 df-row-ss">
                                            ...
                                            <div class="w-50 df-col-ss">
                                                <span class="price-new my-price pl-2">₹{{$productdetail[0]->price}}</span>
                                    ...
                                    <div class="row">
                                        <div class="col-12 df-row-cc mt-2">
                                            <a href="{{url('cart')}}/{{$productdetail[0]->id}}" class="btn  product-buy-button">ADD TO CART</a>
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-12">
                                            <div class="w-100 df-row-cc">
                                                ...
                                                <div class="w-25 df-col-cc">
                                                    <img src="{{asset('public/webpages/assets/image/box.png')}}" alt=""
                                                        class="delivery-icon">
                                       ...
                                       @if($productdetail[0]->print_on_demand == "yes")
                                         ...
                                         <div class="row  pt-2">
                                            <div  class="mx-auto col-10">
                                              ...
                                              <span><strong><i
                                                                    ...
                                                                    Edition :</strong></span>
                                                             <span>{{$productdetail[0]->product_edition}}</span>
                                                    </div>
                                              ...
                                              <span><strong><i
                                                           ...
                                                           <span>{{$productdetail[0]->dimension}}</span>
                                                    </div>
                                              ...
                                              <span><strong><i
                                                           ...
                                                           <span>{{$productdetail[0]->weight}} </span>
                                                    </div>
...
<a href="" class="author">
                            ...
                            <div class="price-block">
                                ...
                                <div style="margin-left: 62px;" class="add-icon">
        <button style="color: white; border-radius: 2px; background-color: rgb(237, 108, 0); width: 190px;" class="d-flex most_recent_1">
                ...
                <div class="single-slide">
                    <div class="product-card">
                        ...
                        <div class="product-card--body">
                            ...
                            <br>
                                 <div style="margin-left: 62px;" class="pb-5">
        <button style="color: white; border-radius: 2px; background-color: rgb(237, 108, 0); width: 190px;" class="d-flex most_recent_1">
                    ...
                    <div class="product-card">
                        ...
                        <div class="product-card--body">
                            ...
                            <div class="price-block">
                             ...
                             <div style="margin-left: 62px;" class="pb-5">
        <button style="color: white; border-radius: 2px; background-color: rgb(237, 108, 0); width: 190px;" class="d-flex related_product">
    ...
    <section class="">
        ...
        <div class="container my-container">
            <div class="brand-slider sb-slick-slider border-top border-bottom" data-slick-setting='{
                ...
                <div class="single-slide">
                    <img src="{{asset('public/webpages/assets/image/products/product-2.jpg')}}">
                </div>
                <div class="single-slide">
                    <img src="{{asset('public/webpages/assets/image/products/product-3.jpg')}}">
                </div>
                <div class="single-slide">
                    <img src="{{asset('public/webpages/assets/image/products/product-4.jpg')}}">
                </div>
                <div class="single-slide">
                    <img src="{{asset('public/webpages/assets/image/products/product-5.jpg')}}">
                </div>
                <div class="single-slide">
                    <img src="{{asset('public/webpages/assets/image/products/product-1.jpg')}}">
                </div>
