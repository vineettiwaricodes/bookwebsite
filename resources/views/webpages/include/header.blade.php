 ...
 -->
            ...
            <div class="col-lg-8 flex-lg-right">
                <ul class="header-top-list">
                    ...
                    @if(Auth::user())
                    <li class="dropdown-trigger language-dropdown"><a href="{{url('my-account')}}"><i style="color: blue"  
                                class="icons-left  fas fa-user"></i>
                            My Account |</a><i class="fas fa-chevron-down dropdown-arrow"></i>
                        <ul class="dropdown-box">
                            <li> <a href="{{url('my-account')}}">My Account</a></li>
                            <li> <a href="{{url('order-complete')}}">Order History</a></li>
                    ...
                    <li class="dropdown-trigger language-dropdown"><a href="#" data-toggle="modal" data-target="#myModal"><i style="color: blue"  
                       ...
                       @if(Auth::user())
                            ...
                            <li> <a href="{{url('my-account#orders')}}">Order History</a></li>
                            <li> <a href="">Transactions</a></li>
                            <li> <a href="">Downloads</a></li>
                        @else
                    ...
                    <li><a href="{{url('contact')}}"><i class="icons-left text-success fas fa-phone"></i> Contact |</a>
                    </li>
                    <li><a href="{{url('check_out')}}"><i class="icons-left text-danger fas fa-share"></i> Checkout |</a>
                    </li>
            ...
            <div class="row align-items-center">
                <div class="col-lg-3">
                    <a href="{{url('index')}}" class="site-brand">
                        <img src="{{asset('public/webpages/assets/image/logo.png')}}" alt="">
                    </a>
                </div>
                <div class="col-lg-7 d-flex flex-row justify-content-start align-item-center ">
                    ...
                    <div class="header-search-block   d-flex flex-row justify-content-start align-item-center"
                        ...
                        <form  action="{{url('search')}}" method="post" class="w-100">
                     {{csrf_field()}}
                        ...
                        <a href="{{url('/result')}}"> <button  class="search-btn" type="submit">Search</button></a>
...
<div style="color: green"><svg   xmlns="http://www.w3.org/2000/svg"  width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#2e3292" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path  d="M6 2L3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4z"></path><line x1="3" y1="6" x2="21" y2="6"></line><path d="M16 10a4 4 0 0 1-8 0"></path></svg></div> -->
                                  ...
                                  <a href="{{url('cartdata')}}"><h5><span style="color: green" class="text-item">
                                        <strong>
...
<!-- 
                                 <img src="public/webpages/assets/image/cart.png" width="87px" height="auto">
                                  ...
                                  <img
                                    src="{{asset('public/webpages/assets/image/cart.png' )}}"> -->
                                ...
                                <div class="cart-dropdown-block">
                                    <div class=" single-cart-block ">
                                        <div class="cart-product">
                                            <a href="{{url('cart')}}" class="image">
                                                <img
                                                    src="{{asset('public/webpages/assets/image/products/product-1.jpg')}}">
                                            </a>
                                            <div class="content">
                                                <h3 class="title"><a href="{{url('cart')}}"></a></h3>
                                    ...
                                    <div class=" single-cart-block ">
                                        <div class="btn-block">
                                            <a href="{{url('cartdata')}}" class="btn">View Cart <i
                        ...
                        <ul class="main-menu menu-right main-menu--white li-last-0">
                            <li class="menu-item has-children">
                                 <a class="category-trigger" href="javascript:void(0)">EXAMS  
                                     ...
                                     <img style="padding-left: 3px" src="{{asset('public/webpages/assets/image/icons2.png')}}" width="13px" height="auto"  alt="">



<!-- 
                                            <img class="dropdown" 
                                                    src="{{asset('public/webpages/assets/image/icons2.png')}}> -->
            ...
            <div class="row align-items-sm-end align-items-center">
                ...
                <div  class="col-md-5 order-3 order-md-2 d-flex flex-row justify-content-start align-item-center">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <a href="{{url('result')}}" class="input-group-append">
        ...
        <div class="off-canvas-inner">
            ...
            <div class="mobile-navigation">
                ...
                <div class="w-100  d-flex justify-content-start align-items-center d-flex ">
                    <!-- <img src="{{asset('public/webpages/assets/image/user-profile.png')}}" width="40px" alt=""> -->
                     <a href="{{url('index')}}" class="site-brand">
                        <img style="margin-right: 40px;" src="{{asset('public/webpages/assets/image/logo.png')}}" alt="" height="auto" width="280px">
                    </a>
                ...
                <nav class="off-canvas-nav">
                    <ul class="mobile-menu main-mobile-menu">
                        ...
                        <li class="menu-item-has-children">
                                 ...
                                 <!--  <img src="{{asset('public/webpages/assets/image/m-menu/1.png')}}" alt="">  -->
<i class='fab fa-leanpub'></i>
                        ...
                        <li class="menu-item-has-children">
                                 <a href="#" class="d-flex flex-row justify-content-start align-items-center">  <!-- <img src="{{asset('public/webpages/assets/image/m-menu/1.png')}}" alt=""> -->
                     ...
                     <!--    <li class="menu-item-has-children">
                                 <a href="#" class="d-flex flex-row justify-content-start align-items-center">  <img src="{{asset('public/webpages/assets/image/m-menu/1.png')}}" alt="">  <span>Exam</span> <i class="fas fa-angle-down ml-auto"></i></a>
                            <ul class="sub-menu">
                                <li class="menu-item-has-children">
 ...
 -->
            ...
            <nav class="off-canvas-nav">
                <ul class="mobile-menu menu-block-2">
                    ...
                    <!--</li>-->
                    <li class="menu-item-has-children">
                        <a href="{{url('my-account')}}">My Account <i class="fas fa-angle-down"></i></a>
                        <ul class="sub-menu">
                            <li><a href="{{url('my-account')}}">My Account</a></li>
                            <li><a href="{{url('order-complete')}}">Order History</a></li>
                            <li><a href="">Transactions</a></li>
        ...
        <div class="row align-items-center">
            ...
            <div style="margin-bottom: 2px;" class="col-lg-7 d-flex flex-row justify-content-start align-item-center  ">
                ...
                <div class="header-search-block  d-flex flex-row justify-content-start align-item-center  "
                    ...
                    <a href="{{url('/result')}}"> <button>Search</button></a>
                        ...
                        <form>
                            <div class="login-form">
                                ...
                                <div class="row">
                                 ...
                                 <input type="email" name="login_email" class="mb-0 form-control" value="{{isset($_COOKIE['user_email'])?$_COOKIE['user_email']:''}}" placeholder="Enter Your Email"  id="value">
                                    </div>
                                    <div class="col-12 mb--20">
                                        ...
                                        <!-- <input class="mb-0 form-control" type="password" id="login-password"
                                            ...
                                            <input type="password" class=" form-control" value="{{isset($_COOKIE['password'])?$_COOKIE['password']:''}}" name="login_password" placeholder="Enter Password"  id="value"> 
...
<div class="check">
                                    ...
                                    <span>{{__('messages.rem_me')}}</span>
                                        ...
                                        <h6 class="w-100 text-left ">  <a href="javascript:forgotmodel()">{{__('messages.lost_pwd')}}</a></h6>
                                    ...
                                    <div class="col-md-12">
                                        <input type="button" class="btn text-white product-buy-button" name="btnlogin" onclick="loginuser('login_')" value="{{__('messages.login')}}" class="regiterbtn" style="background-color: <?= Session::get('site_color') ?> !important"/>
                                    </div> 
                        ...
                        <form >
                            <div class="login-form">
                                ...
                                <div class="row">
                                 ...
                                 <input class="mb-0 form-control" type="text" name="first_name"  id="value" placeholder="{{__('messages.name')}}">
                                    </div>
                                    <div class="col-12 mb--20">
                                        <label for="email">Email</label>
                                        <!-- <input class="mb-0 form-control" type="email" id="email"
                                            placeholder="Enter Your Email Address Here.."> -->
                                            <input  class="mb-0 form-control" type="email"  name="reg_email"  id="value" placeholder="{{__('messages.email')}}">
                                    ...
                                    <div class="col-12 mb--20">
                                        ...
                                        <!-- <input class="mb-0 form-control" type="email" id="email"
                                            placeholder="Enter Your Email Address Here.."> -->
                                            <input  class="mb-0 form-control" type="text" name="reg_phone" id="value" placeholder="{{__('messages.phone')}}">
                                    ...
                                    <div class="col-lg-6 mb--20">
                                        ...
                                        <!-- <input class="mb-0 form-control" type="password" id="password"
                                            placeholder="Enter your password"> -->
                                            <input class="mb-0 form-control" type="password" name="reg_password"  id="value" placeholder="{{__('messages.password')}}">
                                    </div>
                                    <div class="col-lg-6 mb--20">
                                        <label for="password">Repeat Password</label>
                                        <!-- <input class="mb-0 form-control" type="password" id="repeat-password"
                                            placeholder="Repeat your password"> -->
                                            <input class="mb-0 form-control" type="password" name="confirm_password" id="value" placeholder="{{__('messages.confirm_password')}}">
                                    </div>
                                    <div class="col-md-12">
