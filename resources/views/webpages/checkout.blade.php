									...
									<div class="row">
										...
										<div class="col-12">
											<div class="checkout-cart-total">
												...
												<ul>
													<li><span class="left">{{$product[0]->name}}</span> <span
															class="right">₹{{$product[0]->price}}</span></li>
													
													
												</ul>
												<!-- <p>Sub Total <span>$104.00</span></p> -->
												<p>Shipping Fee <span>₹00.00</span></p>
												<h4>Grand Total <span>₹{{$product[0]->price}}</span></h4>
												...
												<a href="{{url('order')}}/{{$product[0]->id}}" class="place-order w-100" type="button">Place order</a>
											</div>
										</div>
									</div>
								</div>
