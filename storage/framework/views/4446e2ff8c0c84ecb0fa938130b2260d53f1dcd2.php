   ...
   <div class="col-sm-4 float-right-1">
      <div class="page-header float-left float-right-1">
         <div class="page-title">
            <h1><?php echo e(__('messages.admin')); ?></h1>
         </div>
      </div>
   </div>
      ...
      <div class="col-12">
         <div class="card">
            <div class="card-body">
               ...
               <?php endif; ?>
               <button  data-toggle="modal" data-target="#adduser" class="btn btn-primary btn-flat m-b-30 m-t-30" ><?php echo e(__('messages.add_admin')); ?></button>
                  ...
                  <table id="adminTable" class="table table-striped table-bordered dttablewidth">
                     <thead>
                        <tr>
                           ...
                           <th style="vertical-align: top;"><?php echo e(__('messages.name')); ?></th>
                           <th style="vertical-align: top;"><?php echo e(__('messages.email')); ?></th>
                           <th style="vertical-align: top;"><?php echo e(__('messages.phone')); ?></th>
      ...
      <div class="modal-dialog modal-lg" role="document">
         <div class="modal-content">
            <div class="modal-header">
               <h5 class="modal-title" id="smallmodalLabel"><?php echo e(__('messages.add_admin')); ?></h5>
            ...
            <form action="<?php echo e(url('admin/adduser')); ?>" method="post">
               ...
               <div class="modal-body">
                  ...
                  <div class="form-group col-md-12 paddiv">
                     ...
                     <div class="col-md-6">
                        <label for="cc-payment" class="control-label mb-1"><?php echo e(__('messages.phone')); ?><span class="reqfield">*</span></label>
                        <input id="phone" name="phone" type="text" class="form-control"  placeholder="<?php echo e(__('messages.phone')); ?>" required="">
                     </div>
                  </div>
         ...
         <div class="modal-content">
            <div class="modal-header">
               <h5 class="modal-title" id="smallmodalLabel">
                  <?php echo e(__('messages.edit_admin')); ?>
            ...
            <form action="<?php echo e(url('admin/updateuser')); ?>" method="post">
               ...
               <div class="modal-body">
                  ...
                  <div class="form-group col-md-12 paddiv">
                     ...
                     <div class="col-md-6">
                        <label for="cc-payment" class="control-label mb-1"><?php echo e(__('messages.phone')); ?><span class="reqfield">*</span></label>
                        <input id="edit_phone" name="phone" type="text" class="form-control"  placeholder="<?php echo e(__('messages.phone')); ?>" required="">
                     </div>
                  </div>
                  <div class="form-group col-md-12">
                     <label for="cc-payment" class="control-label mb-1"><?php echo e(__('messages.address')); ?></label>
               ...
               <div class="modal-footer">
                  <button type="button" class="btn btn-secondary" data-dismiss="modal"><?php echo e(__('messages.cancel')); ?></button>
                     ...
                     <?php else: ?>
                         <button type="submit" class="btn btn-primary"><?php echo e(__('messages.cancel')); ?></button>
                     <?php endif; ?>
...
<?php echo $__env->make('admin.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ao0bylx163io/public_html/demo.aximoinfotech.com/bookfactory/bookfactoryworking/resources/views/admin/user/admin.blade.php ENDPATH**/ ?>