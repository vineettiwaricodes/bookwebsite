...
<body>
    ...
    <div class="site-wrapper" id="top">
        ...
        <section class="hero-area hero-slider-1">
            <div class="sb-slick-slider" data-slick-setting='{
                ...
                <div class="single-slide bg-shade-whisper">
                    <div class="container-fluid">
                        <div class="home-content text-center text-sm-left position-relative">
                            <img src="<?php echo e(asset('public/webpages/assets/image/gmat-banner-final-cream3.jpg')); ?>" class="slider-img" style>
                        </div>
                    </div>
                </div>
                <!-- <div class="single-slide bg-shade-whisper">
                ...
                <div class="single-slide bg-shade-whisper">
                    <div class="container-fluid">
                        <div class="home-content text-center text-sm-left position-relative">
                            <img src="<?php echo e(asset('public/webpages/assets/image/peacock-banner.jpg')); ?>" class="slider-img" style>
                        </div>
                    </div>
                </div>
                <div class="single-slide bg-shade-whisper">
                    <div class="container-fluid">
                        <div class="home-content text-center text-sm-left position-relative">
                            <img src="<?php echo e(asset('public/webpages/assets/image/newb1.png')); ?>" class="slider-img" style>
                        </div>
                    </div>
                </div>
                <div class="single-slide bg-shade-whisper">
                    <div class="container-fluid">
                        <div class="home-content text-center text-sm-left position-relative">
                            <img src="<?php echo e(asset('public/webpages/assets/image/newb2.png')); ?>" class="slider-img" style>
                        </div>
                    </div>
       ...
       <!--  <button class="bg-success" onclick="prev()">prev</button>
                <button class="bg-success" onclick="next()">next</button> -->
        </section>
...
<!-- offer banner end -->
    ...
    <section class="section-margin ">
        ...
        <div  class="container contain my-container pt-3  pb-3">
           <!--  <div style="border-bottom: 1px solid #ececec" class="w-100 d-flex pb-2  flex-row align-items-center mb-2">
            ...
            <div class="brand-slider  sb-slick-slider" data-slick-setting='{
             ...
             {"breakpoint":320, "settings": {"slidesToShow": 1} }
                ...
                <div class="single-slide mt-1  ">
                   <img src="<?php echo e(asset('public/webpages/assets/image/books.jpeg')); ?>" style="width: 315px" alt="">
                </div>
                <div class="single-slide mt-1">
                    <img src="<?php echo e(asset('public/webpages/assets/image/books.jpeg')); ?>"
                    style="width: 315px" alt="">
                </div>
                <div class="single-slide mt-1  ">
                    <img src="<?php echo e(asset('public/webpages/assets/image/books.jpeg')); ?>"
                    width="315px" alt="">
                    ...
                    <div class="product-card">
                        ...
                        <div class="product-card--body">
                            <div class="card-image">
                               ...
                               <img src="<?php echo e(asset('public/webpages/assets/image/products/product-details-3.jpg')); ?>"
                                    alt=""><br>
                                ...
                                <div class="hover-contents">
                                    <a href="productdetails.php ?>" class="hover-image">
                                     <!--    <img src="<?php echo e(asset('public/webpages/assets/image/products/product-details-2.jpg')); ?>"
                                            alt=""> -->
                           ...
                           <div style="margin-left: 61px;" class="pb-5">
        <button style="color: white; border-radius: 2px; background-color: rgb(237, 108, 0); width: 190px;" class="d-flex feature-boxzz">
...
<div style="border-radius: 1px; height: 32px; margin-top: 1px; background-color: green; width: 30px;">
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ffffff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 2L3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4z"></path><line x1="3" y1="6" x2="21" y2="6"></line><path d="M16 10a4 4 0 0 1-8 0"></path></svg>
       ...
       <h6 style="margin-left: 28px; margin-top: 6px;">ADD TO CART</h6></button>
    </div>    
                    ...
                    <div class="product-card">
                        ...
                        <div class="product-card--body">
                            ...
                            <div class="price-block">
                                <span class="price">₹200</span>
                                <del class="price-old">₹200</del>
                                <span class="price-discount P-2">20%
                                <span> off</span></span>
                            </div>
...
<div style="border-radius: 1px; height: 32px; margin-top: 1px; background-color: green; width: 30px;">
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ffffff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 2L3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4z"></path><line x1="3" y1="6" x2="21" y2="6"></line><path d="M16 10a4 4 0 0 1-8 0"></path></svg>
     ...
     <!--    </div>
        ...
        ===================================== -->
        <section class="section-margin">
            <div class="container my-container pt-3 pt-3">
                <div style="border-bottom: 1px solid #ececec;" class="w-100 pb-2 d-flex  flex-row align-items-center">
                ...
                <div class="single-slide">
                    <div class="product-card">
                        ...
                        <div class="product-card--body">
                           ...
                           <div style="margin-left: 60px;" class="pb-5">
        <button style="color: white; border-radius: 2px; background-color: rgb(237, 108, 0); width: 190px;" class="d-flex most_recent_3">
                ...
                <div class="single-slide">
                    <div class="product-card">
                        ...
                        <div class="product-card--body">
                           ...
                           <div style="margin-left: 13px;" class="pb-5">
        <button style="color: white; border-radius: 2px; background-color: rgb(237, 108, 0); width: 190px;" class="d-flex seller_book">
                                        ...
                                        <?php $__currentLoopData = $product; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Pd): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <?php $__currentLoopData = $Brand; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bd): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                             ...
                                             <span> off</span>
                                                     ...
                                                     <div style="margin-left: 75px;" class="pb-5">
        <button style="color: white; border-radius: 2px; background-color: rgb(237, 108, 0); width: 190px;" class="d-flex seller_book">
 ...
 <section class="">
        ...
        <div class="container my-container pt-3 pb-3 mt-3">
            <div style="border-bottom: 1px solid #ececec" class="w-100 pb-2 d-flex flex-row align-items-center mb-4">
                <h5> <strong>MOST RECENT VIEW BOOK</strong> </h5>
                <a href="#" class="mr-3 btn btn--primary view-all-btn ml-auto"> View all </a>
            </div>
            <div class="product-slider sb-slick-slider slider-border-single-row" data-slick-setting='{
                "autoplay": true,
...
<a href="" class="author">
                                Lpple
                                     ...
                                     <h3><a href="product-details.php">Revolutionize Your BOOK With revolution</a></h3>
                           ...
                           <div style="margin-left: 60px;" class="pb-5">
        <button style="color: white; border-radius: 2px; background-color: rgb(237, 108, 0); width: 190px;" class="d-flex most_recent">
...
<!-- most recent view book end -->
                            ...
                            <div class="product-card--body">
                                <div class="card-image">
                                    <img class="Demo" src="<?php echo e(asset('public/webpages/assets/image/products/product-2.jpg')); ?>" alt=""><br>
                                     <a href="#" class="author">
                                    Lpple
                                </a><h3><a href="<?php echo e(url('product-details')); ?>">Demo Book
                                    </a></h3>
                                    <div class="hover-contents">
        ...
        <button style="color: white; border-radius: 2px; background-color: rgb(237, 108, 0); width: 190px;" class="d-flex children_book">
                            ...
                            <div class="product-card--body">
                                <div class="card-image">
                                    <img src="<?php echo e(asset('public/webpages/assets/image/products/product-2.jpg')); ?>" alt=""><br>
                                      <a href="" class="author">
                                    Jpple
                                </a> <h3><a href="<?php echo e(url('product-details')); ?>">Demo Book</a>
                                </h3>
                                    <div class="hover-contents">
                                        <a href="<?php echo e(url('product-details')); ?>" class="hover-image">
                                            <img src="<?php echo e(asset('public/webpages/assets/image/products/product-1.jpg')); ?>"
       ...
       <h6 style="margin-left: 28px; margin-top: 6px;">ADD TO CART</h6></button>
                    ...
                    <div class="single-slide">
                        <div class="product-card">
                            ...
                            <div class="product-card--body">
                                <div class="card-image">
                                    <img src="<?php echo e(asset('public/webpages/assets/image/products/product-3.jpg')); ?>" alt=""><br>
                                     <a href="" class="author">
                                    Wpple
                                </a> <h3><a href="<?php echo e(url('product-details')); ?>">Demo Book</a></h3>
                                    <div class="hover-contents">
                                        <a href="<?php echo e(url('product-details')); ?>" class="hover-image">
       ...
       <h6 style="margin-left: 28px; margin-top: 6px;">ADD TO CART</h6></button>
                    ...
                    <div class="single-slide">
                        <div class="product-card">
                            ...
                            <div class="product-card--body">
                                <div class="card-image">
                                    <img src="<?php echo e(asset('public/webpages/assets/image/products/product-5.jpg')); ?>" alt=""><br> 
                                     <a href="" class="author">
                                    Epple
                                </a> <h3><a href="<?php echo e(url('product-details')); ?>">Demo Book</a>
                                </h3>
       ...
       <h6 style="margin-left: 28px; margin-top: 6px;">ADD TO CART</h6></button>
                    ...
                    <div class="single-slide">
                        <div class="product-card">
                            ...
                            <div class="product-card--body">
                                <div class="card-image">
                                    <img src="<?php echo e(asset('public/webpages/assets/image/products/product-6.jpg')); ?>" alt=""><br>
                                       <a href="" class="author">
                                    Hpple
                                </a> <h3><a href="<?php echo e(url('product-details')); ?>">Demo Book</a></h3>
                                    <div class="hover-contents">
       ...
       <h6 style="margin-left: 28px; margin-top: 6px;">ADD TO CART</h6></button>
                    ...
                    <div class="single-slide">
                        <div class="product-card">
                            ...
                            <div class="product-card--body">
                                <div class="card-image">
                                    <img src="<?php echo e(asset('public/webpages/assets/image/products/product-8.jpg')); ?>" alt=""><br> 
                                     <a href="#" class="author">
                                    Bpple
                                </a><h3><a href="<?php echo e(url('product-details')); ?>">Demo Book</a></h3>
                                    <div class="hover-contents">
                                ...
                                <div class="price-block">
                                    ...
                                    <span> off</span></span>
                                                            ...
                                                            <div style="margin-left: 15px;" class="pb-5">
        <button style="color: white; border-radius: 4px; background-color: rgb(237, 108, 0); width: 190px;" class="d-flex children_book">
       ...
       <h6 style="margin-left: 28px; margin-top: 6px;">ADD TO CART</h6></button>
                    ...
                    <div class="single-slide">
                        <div class="product-card">
                            ...
                            <div class="product-card--body">
                                <div class="card-image">
                                    <img src="<?php echo e(asset('public/webpages/assets/image/products/product-13.jpg')); ?>" alt=""><br>
                                     <a href="#" class="author">
                                    zpple
                                </a> <h3><a href="<?php echo e(url('product-details')); ?>">Demo Book
                                    </a>
...
<div style="border-radius: 1px; height: 32px; margin-top: 1px; background-color: green; width: 30px;">
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ffffff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 2L3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4z"></path><line x1="3" y1="6" x2="21" y2="6"></line><path d="M16 10a4 4 0 0 1-8 0"></path></svg>
       ...
       <h6 style="margin-left: 28px; margin-top: 6px;">ADD TO CART</h6></button>
        ...
        ===================================== -->
        <section class="section-margin">
            <div class="container my-container pad-1 pt-3 pb-3">
                <div style="border-bottom: 1px solid #ececec" class="w-100 pb-2 d-flex flex-row align-items-center mb-4">
                            ...
                            <div class="product-card--body">
                                ...
                                <div class="price-block">
                                    ...
                                    <span> off</span></span>
                                                           ...
                                                           <div style="margin-left: 33px;" class="pb-5">
        <button style="color: white; border-radius: 2px; background-color: rgb(237, 108, 0); width: 190px;" class="d-flex art_photography">
...
<?php /**PATH /home/ao0bylx163io/public_html/demo.aximoinfotech.com/bookfactory/bookfactoryworking/resources/views/webpages/index.blade.php ENDPATH**/ ?>