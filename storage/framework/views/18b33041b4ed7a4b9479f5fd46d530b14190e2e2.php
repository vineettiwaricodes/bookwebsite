            ...
            <div class="sb-slick-slider" data-slick-setting='{
                ...
                <div class="single-slide bg-shade-whisper">
                    <div class="container-fluid">
                        ...
                        <img class="banner-img" src="public/upload/banner/image/<?php echo e($b['Image']); ?> ">
                            <!-- <img  class="banner-img" src="<?php echo e(asset('public/upload/banner')); ?>" class="slider-img"> -->
            ...
            <div class="brand-slider  sb-slick-slider" data-slick-setting='{
             ...
             {"breakpoint":320, "settings": {"slidesToShow": 1} }
                ...
                <div style="margin-left: 1px;" class="single-slide  ">
                   <img class="offer_banner" src="<?php echo e(asset('/public/upload/offer/image/' . $bigOffer['banner'])); ?>" alt="">
                </div>
                <div style="margin-left: 1px;" class="single-slide ">
                    <img class="offer_banner" id="off" src="<?php echo e(asset('/public/upload/offer/image/' . $normalOffer['banner'])); ?>"
                     alt="">
                </div>
                <div style="margin-left: 1px;" class="single-slide   ">
                    <img  class="offer_banner"  src="<?php echo e(asset('/public/upload/offer/image/' . $seasonalOffer['banner'])); ?>"
                     alt="">
                </div>

                <div class="single-slide ">
                    <img class="offer_banner" id="off" src="<?php echo e(asset('/public/upload/offer/image/' . $currentOffer->offer->banner)); ?>"
                     alt="">
                </div>
       ...
       <h6 class="chi_heading">ADD TO CART</h6></button>
                    ...
                    <div class="single-slide">
                        <div  class="product-card">
                            ...
                            <div class="product-card--body">
                                <div class="card-image">
                                    <img class="image_size" src="<?php echo e(asset('public/webpages/assets/image/products/demo3.jpg')); ?>" alt=""><br>
                 ...
                 <div class="single-slide">
                        <div  class="product-card">
                            ...
                            <div  id="op" class="product-card--body">
                                <div class="card-image">
                                    <img class="image_size" src="<?php echo e(asset('public/webpages/assets/image/products/demo2.png')); ?>" alt=""><br>
...
<div class="chi_icon">
   ...
   <section class="section-margin">
            ...
            <?php $__currentLoopData = $dealofday; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="single-slide">
                    <div class="product-card">
                        <div class="product-header">
                        </div>
                        <div class="product-card--body">
                            ...
                            <img class="image_size"  src="public/upload/product/<?php echo e($i['productdata']['basic_image']); ?> ">
                                    <br>
                                <div class="hover-contents">
                                    <a href="<?php echo e(url('product-details')); ?>" class="hover-image">
                                    ...
                                    <div class="hover-btns">
                                        ...
                                        <a href="addtowishlist/<?php echo e($i->id); ?>" class="single-btn">
                                            <i class="fas fa-heart"></i>
                                        </a>
                            ...
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                               <h3><a href="productdetails/<?php echo e($i->id); ?>"><?php echo e($i['productdata']['name']); ?></a></h3>
                             </div>

                            <div class="price-block">
                                <span class="price">₹<?php echo e($i['productdata']['price']); ?></span>
                                <del class="price-old">₹<?php echo e($i['productdata']['MRP']); ?></del>
                                <span class="price-discount"><?php echo e($i['productdata']['discount']); ?>%
                                <span> off</span></span>
                            </div>
                            <br>
    ...
    <a href="<?php echo e(url('addcartdata/'.$i->id)); ?>"><h6 class="fe_heading">ADD TO CART</h6></button></a>
    </div> 
        ...
        <section class="bg-image section-padding pt-2">
            ...
            <div class="container my-container pt-3 pb-3">
                <div style="border-bottom: 1px solid #ececec" class="w-100 d-flex pb-2  flex-row align-items-center">
                    ...
                    <a href="<?php echo e(url('viewall')); ?>" class="mr-3 btn btn--primary view-all-btn ml-auto"> View all</a>
                </div>
...
<!-- 
 <section class="">
   ...
   <section class="section-margin">
            ...
            <?php $__currentLoopData = $bestseller; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="single-slide">
                        <div class="product-card">
                            <div class="product-header">
                            ...
                            <div class="product-card--body">
                                <div class="card-image">
                                <img class="image_size_1" src="public/upload/product/<?php echo e($i['productdata']['basic_image']); ?>  "><br>
       ...
       <h6 class="chi_heading">ADD TO CART</h6></button>
                     ...
                     <div class="single-slide">
                        <div class="product-card">
                            ...
                            <div class="product-card--body">
                                <div class="card-image">
                                    <img class="image_size" src="<?php echo e(asset('public/webpages/assets/image/products/virat.jpg')); ?>" alt=""><br>
                                   
                                    <div class="hover-contents">
                                        <a href="<?php echo e(url('product-details')); ?>" class="hover-image">
                                           <!--  <img src="<?php echo e(asset('public/webpages/assets/image/products/demo2.png')); ?>"
                                                alt=""> -->
                                        </a>
                                        <div class="hover-btns">
                                            <a href="#" class="single-btn">
                        ...
                        <div  class="product-card">
                            ...
                            <div class="product-card--body">
                                <div class="card-image">
                                    ...
                                    <div class="hover-contents">
                                        <a href="<?php echo e(url('product-details')); ?>" class="hover-image">
                                           <!--  <img src="<?php echo e(asset('public/webpages/assets/image/products/.jpg')); ?>"
                                                alt=""> -->
                                        </a>
                                        <div class="hover-btns">
                                            <a href="#" class="single-btn">
...
<!-- most recent view book end -->
        ...
        <section class="section-margin">
            <div class="container my-container   pt-3 pb-3">
                <div style="border-bottom: 1px solid #ececec" class="w-100 pb-2 d-flex flex-row align-items-center mb-4">
                    ...
                    <a href="<?php echo e(url('viewallchildren')); ?>" class="mr-3 btn btn--primary view-all-btn ml-auto"> View all</a>
                </div>
   ...
   <section class="section-margin">
            ...
            <?php $__currentLoopData = $childrenbook; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="single-slide">
                    <div class="product-card">
                        <div class="product-header">
                            <!-- <a href="" class="author">
                        ...
                        <div class="product-card--body">
                            ...
                            <img class="image_size" src="public/upload/product/<?php echo e($i['basic_image']); ?> ">
                                    <br>
...
<div class="fe_icon">
        ...
        <section class="section-margin">
            <div class="container my-container   pt-3 pb-3">
                <div style="border-bottom: 1px solid #ececec" class="w-100 pb-2 d-flex flex-row align-items-center mb-4">
                    ...
                    <a href="<?php echo e(url('viewallart')); ?>" class="mr-3 btn btn--primary view-all-btn ml-auto"> View all</a>
                </div>
   ...
   <section class="section-margin">
            ...
            <?php $__currentLoopData = $artbooks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="single-slide">
                    <div class="product-card">
                        <div class="product-header">
                            <!-- <a href="" class="author">
                        ...
                        <div class="product-card--body">
                            ...
                            <img class="image_size" src="public/upload/product/<?php echo e($i['basic_image']); ?> "><br>
                                    <br>
...
<div class="fe_icon">
    ...
    <a href="<?php echo e(url('addcartdata/'.$i->id)); ?>"><h6 class="fe_heading">ADD TO CART</h6></button></a>
        ...
        <section class="section-margin">
            ...
            <?php $__currentLoopData = $blogdata; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="single-slide">
                        <div class="blog-card">
                            <div class="image">
                            ...
                            <div class="content">
                                <div class="content-header">
                                    ...
                                    <h3 class="title"><a href="blog-details.php"><?php echo e($i->title); ?></a>
                                    </h3>
                                </div>
            ...
            <div class="brand-slider drag sb-slick-slider" data-slick-setting='{
             ...
             {"breakpoint":320, "settings": {"slidesToShow": 1} }
                ...
                <div class="single-slide">
                    ...
                    <a href="#"><img class="img-back"   src="<?php echo e(asset('public/webpages/assets/image/products/sachin.jpg')); ?>" alt=""></a>
                ...
                <div class="single-slide">
                    <a href=""><img class="img-back"   src="<?php echo e(asset('public/webpages/assets/image/products/virat.jpg')); ?>" alt=""></a>
                     <h6 class="author_name">Virat kohli</h6>
                </div>
                <div class="single-slide">
                  <a href=""><img class="img-back"   src="<?php echo e(asset('public/webpages/assets/image/products/demo2.png')); ?>" alt=""></a>
                   <h6 class="author_name">Sachin tendulakar</h6>
                </div>
                <div class="single-slide">
             <a href=""> <img class="img-back"   src="<?php echo e(asset('public/webpages/assets/image/products/john.jpg')); ?>" alt=""></a>
               <h6 class="author_name">Sachin tendulkar</h6>
                </div>
...
<!--     <section class="section-margin ">
        ...
        <div class="container my-container pt-3  pb-3">
            <div style="border-bottom: 1px solid #ececec" class="w-100 d-flex pb-2  flex-row align-items-center mb-2">
                <h5> <strong>Buy Books by Author</strong> </h5>
                <a  href="<?php echo e(url('viewallbookbyauthor')); ?>" class="mr-3 btn btn--primary view-all-btn ml-auto"> View all </a>
            </div>
            <div class="brand-slider drag sb-slick-slider" data-slick-setting='{
                                         "autoplay": true,
                                         "autoplaySpeed": 8000,
         ...
         <?php $__currentLoopData = $author; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
                ...
                <div class="single-slide">
                <a href="<?php echo e(url('viewbookbyauthor/'.$i->id)); ?>">
        ...
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> 
            ...
            <div class="img-back-2">
                ...
                <img class="img-back"   src="<?php echo e(asset('public/webpages/assets/image/products/sachin.jpg')); ?>" alt="">
                
                <img class="img-back" src="<?php echo e(asset('public/webpages/assets/image/products/demo2.png')); ?>" alt="">
            </div>
        </div>
    </section>
 -->
    ...
    <section class="section-margin ">
        ...
        <div class="container my-container pt-3  pb-3">
            <div style="border-bottom: 1px solid #ececec" class="w-100 d-flex pb-2  flex-row align-items-center mb-2">
                ...
                <a  href="<?php echo e(url('viewallbookbypublisher')); ?>" class="mr-3 btn btn--primary view-all-btn ml-auto"> View all </a>
            </div>
            <div class="brand-slider drag sb-slick-slider" data-slick-setting='{
                                         "autoplay": true,
                                         "autoplaySpeed": 8000,
         ...
         <?php $__currentLoopData = $publisher; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="single-slide">
                <a href="<?php echo e(url('viewbookbypublisher/'.$k->id)); ?>">
...
<?php /**PATH C:\xampp\htdocs\latestbook\resources\views/webpages/index.blade.php ENDPATH**/ ?>