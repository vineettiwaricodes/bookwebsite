                                ...
                                <table class="table table-striped cmr1" id="sortable">
                                    ...
                                    <tbody id="lstable">
                                        <tr id="row1">
                                            ...
                                            <td>
                                                <select name="price_type[]" required id="price_type_1" class="form-control">
                                                    <option value="1"><?php echo e(__('messages.Fixed')); ?></option>
                                                    <option value="2"><?php echo e(__('messages.percentage')); ?></option>
                                                </select>
                                            </td>
                                            <td>
...
<?php echo $__env->make('admin.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bookfactory\resources\views\email\admin\product\addoptionvalues.blade.php ENDPATH**/ ?>