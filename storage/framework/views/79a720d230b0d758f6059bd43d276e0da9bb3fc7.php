        ...
        <div class="row">
            ...
            <div class="col-lg-8 flex-lg-right">
                <ul class="header-top-list">
                    ...
                    <li class="dropdown-trigger language-dropdown"><a href="<?php echo e(url('wishlist')); ?>"><i class="icons-left far fa-heart"></i>
                            wishlist (0) |</a>
                    </li>
                    <li class="dropdown-trigger language-dropdown"><a href="<?php echo e(url('my-account')); ?>"><i
                    ...
                    <li><a href="<?php echo e(url('contact')); ?>"><i class="icons-left fas fa-phone"></i> Contact</a>
                    </li>
                    <li><a href="<?php echo e(url('check_out')); ?>"><i class="icons-left fas fa-share"></i> Checkout</a>
                    </li>
                    <li><a href="#" data-toggle="modal" data-target="#trackOrderModal"><i class="icon-left fas fa-truck-moving"></i> Track Order</a>
                    </li>
                    <li><a href="#" data-toggle="modal" data-target="#myModal"><i
                                class="icons-left fas fa-lock"></i> Sign
                            In</a>
                    </li>
                </ul>
            </div>
                ...
                <div class="col-lg-7 d-flex flex-row justify-content-start align-item-center ">
                    ...
                    <div class="header-search-block  d-flex flex-row justify-content-start align-item-center"
                     ...
                     <?php echo e(csrf_field()); ?>
                        ...
                        <input type="text" required name="search_product" placeholder="Search Books by title,Author " id="search_product" value="<?=isset($_GET['s'])?$_GET['s']:''; ?>" onfocus="changesearcat()">
                                ...
                                <div class="cart-dropdown-block">
                                    <div class=" single-cart-block ">
                                        <div class="cart-product">
                                            ...
                                            <div class="content">
                                                <h3 class="title"><a href="<?php echo e(url('cart')); ?>">Demo Book</a></h3>
                                                <p class="price"><span class="qty">1 ×</span> ₹200</p>
                                    ...
                                    <div class=" single-cart-block ">
                                        <div class="btn-block">
                                            <a href="<?php echo e(url('cart')); ?>" class="btn">View Cart <i
                                                    class="fas fa-chevron-right"></i></a>
                                            <a href="<?php echo e(url('checkout')); ?>" class="btn btn--primary">Check Out <i
                                                    class="fas fa-chevron-right"></i></a>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-lg-8">
                    <div class="main-navigation flex-lg-right">
                        <ul class="main-menu menu-right main-menu--white li-last-0">
                            ...
                            <!-- Blog -->
                            <li class="menu-item has-children ">
                                <a href="javascript:void(0)">REGIONALS</a>
                                <ul class="sub-menu">
    ...
    <aside class="off-canvas-wrapper">
        ...
        <div class="off-canvas-inner">
            ...
            <div class="mobile-navigation">
                ...
                <div class="w-100 mb-4 d-flex justify-content-start align-items-center d-flex ">
                    <img src="<?php echo e(asset('public/webpages/assets/image/user-profile.png')); ?>" width="40px" alt="">
                    <h6 class="ml-4 ">Hello ! username </h6>
                </div>
                ...
                <nav class="off-canvas-nav">
                    <ul class="mobile-menu main-mobile-menu">
                        ...
                        <li class="menu-item-has-children">
                                 <a href="#" class="d-flex flex-row justify-content-start align-items-center">  <img src="<?php echo e(asset('public/webpages/assets/image/m-menu/1.png')); ?>" alt="">  <span>Academics</span> <i class="fas fa-angle-down ml-auto"></i></a>
                            <ul class="sub-menu">
                                <li class="menu-item-has-children">
                                 ...
                                 <input type="email" name="login_email" class="mb-0 form-control" value="<?php echo e(isset($_COOKIE['user_email'])?$_COOKIE['user_email']:''); ?>" placeholder="Enter Your Email"  id="value">
                                    ...
                                    <div class="col-12 mb--20">
                                        ...
                                        <!-- <input class="mb-0 form-control" type="password" id="login-password"
                                            ...
                                            <input type="password" class="mb-0 form-control" value="<?php echo e(isset($_COOKIE['password'])?$_COOKIE['password']:''); ?>" name="login_password" placeholder="Enter Password"  id="value"> <br>
                                             
                                            <input type="checkbox" <?php echo isset($_COOKIE[ 'rem_me'])? "checked": ''?> id="html" name="login_remember"><br>
                                    <label for="html">
                                    <span><?php echo e(__('messages.rem_me')); ?></span>
                                    </label>
                                        <h6 class="w-100 text-right mt-4">  <a href="javascript:forgotmodel()"><?php echo e(__('messages.lost_pwd')); ?></a></h6>
                                    </div>

                                    <div class="col-md-12">
                                        <!-- <a href="#" class="btn product-buy-button">Login</a> -->
                                        <input type="button" class="btn product-buy-button" name="btnlogin" onclick="loginuser('login_')" value="<?php echo e(__('messages.login')); ?>" class="regiterbtn" style="background-color: <?= Session::get('site_color') ?> !important"/>
                                    </div>
                            ...
                            <div class="login-form">
                                ...
                                <div class="row">
                                 ...
                                 <input class="mb-0 form-control" type="text" name="first_name"  id="value" placeholder="<?php echo e(__('messages.name')); ?>">
                                    ...
                                    <div class="col-md-12">
                                    <input  class="btn product-buy-button" type="button" name="btnsubmit" onclick="registeruser()" value="REGISTER" class="regiterbtn" style="background-color: <?= Session::get('site_color') ?> !important"/>
                                        <!-- <a href="#" class="btn product-buy-button">Register</a> -->
                                    </div>
                                </div>
                            </div>
                        </form>
...
</div><?php /**PATH C:\xampp\htdocs\bookfactory\resources\views\webpages\include\header.blade.php ENDPATH**/ ?>