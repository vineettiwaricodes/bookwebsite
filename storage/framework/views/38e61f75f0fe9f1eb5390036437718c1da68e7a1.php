                ...
                <ul class="main-menu menu-right ">
                  ...
                  <li class="menu-item has-children mega-menu">
                    ...
                    <ul class="sub-menu four-column">
                      ...
                      <li class="cus-col-25">
                        <h3 class="menu-title"> <a href="javascript:void(0)">Product Details 1</a></h3>
                        <ul class="mega-single-block">
                          <li><a href="product-details.php">Product Details Page</a></li>
                          <li><a href="product-details-affiliate.php">Product Details Affiliate</a></li>
                          <li><a href="product-details-group.php">Product Details Group</a></li>
                          <li><a href="product-details-variable.php">Product Details Variables</a></li>
                        </ul>
                      </li>
                      <li class="cus-col-25">
                        <h3 class="menu-title"><a href="javascript:void(0)">Product Details 2</a></h3>
                        <ul class="mega-single-block">
                          <li><a href="product-details-left-thumbnail.php">left Thumbnail</a></li>
                    ...
                    <div class="cart-dropdown-block">
                      <div class=" single-cart-block ">
                        <div class="cart-product">
                          ...
                          <div class="content">
                            <h3 class="title"><a href="product-details.php">Kodak PIXPRO Astro Zoom AZ421 16 MP</a></h3>
        ...
        <div class="row space-db-lg--60 space-db--30">
          <div class="col-lg-4 col-md-6 mb-lg--60 mb--30">
            <div class="blog-card card-style-grid">
              ...
              <div class="card-content">
                <h3 class="title"><a href="blog-details.php">Use BLOG TITLE To Make Someone Fall In Love</a></h3>
          ...
          <div class="col-lg-4 col-md-6 mb-lg--60 mb--30">
            <div class="blog-card card-style-grid">
              ...
              <div class="card-content">
                <h3 class="title"><a href="blog-details.php">Ho To (Do) BLOG TITLE Without Your Office(House).</a></h3>
          ...
          <div class="col-lg-4 col-md-6 mb-lg--60 mb--30">
            <div class="blog-card card-style-grid">
              ...
              <div class="card-content">
                <h3 class="title"><a href="blog-details.php">How to Grow Epiphytic Tropical Plants</a></h3>
          ...
          <div class="col-lg-4 col-md-6 mb-lg--60 mb--30">
            <div class="blog-card card-style-grid">
              ...
              <div class="card-content">
                <h3 class="title"><a href="blog-details.php">Want A Thriving Business? Focus On BLOG TITLE!</a></h3>
          ...
          <div class="col-lg-4 col-md-6 mb-lg--60 mb--30">
            <div class="blog-card card-style-grid">
              ...
              <div class="card-content">
                <h3 class="title"><a href="blog-details.php">Grow to Epiphytic Tropical Plants</a></h3>
                <p class="post-meta"><span>30/10/2017 </span> | <a href="#">Hastech</a></p>
                <article>
                  <h2 class="sr-only">
                    Blog Article
          ...
          <div class="col-lg-4 col-md-6 mb-lg--60 mb--30">
            <div class="blog-card card-style-grid">
              ...
              <div class="card-content">
                <h3 class="title"><a href="blog-details.php">Want More Money? Start BLOG TITLE</a></h3>
                <p class="post-meta"><span>30/10/2017 </span> | <a href="#">Hastech</a></p>
                <article>
                  <h2 class="sr-only">
                    Blog Article
          ...
          <div class="col-lg-4 col-md-6 mb-lg--60 mb--30">
            <div class="blog-card card-style-grid">
              ...
              <div class="card-content">
                <h3 class="title"><a href="blog-details.php">Beware The BLOG TITLE Scam</a></h3>
                <p class="post-meta"><span>30/10/2017 </span> | <a href="#">Hastech</a></p>
                <article>
                  <h2 class="sr-only">
                    Blog Article
          ...
          <div class="col-lg-4 col-md-6 mb-lg--60 mb--30">
            <div class="blog-card card-style-grid">
              ...
              <div class="card-content">
                <h3 class="title"><a href="blog-details.php">9 Ways BLOG TITLE Can Make You Invincible</a></h3>
                <p class="post-meta"><span>30/10/2017 </span> | <a href="#">Hastech</a></p>
                <article>
                  <h2 class="sr-only">
                    Blog Article
  ...
  <footer class="site-footer">
    ...
    <div class="footer-bottom">
      <div class="container">
        ...
        <p class="copyright-text">Copyright © 2019 <a href="#" class="author">Pustok</a>. All Right Reserved. <br>
        Design By Pustok</p>
      </div>
    </div>
  </footer>
...
</html><?php /**PATH C:\xampp\htdocs\bookfactory\resources\views\webpages\blog.blade.php ENDPATH**/ ?>