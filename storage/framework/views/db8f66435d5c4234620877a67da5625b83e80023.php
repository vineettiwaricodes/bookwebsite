            ...
            <div class="card-body">
               ...
               <form action="<?php echo e(url('admin/updatetaxdata')); ?>" method="post" enctype="multipart/form-data">
                  ...
                  <div class="row form-group">
                     ...
                     <div class="col-12 col-md-9">
                        <input  type="number" id="rate" step="any" placeholder="<?php echo e(__('messages.rate')); ?>" class="form-control" name="rate" value="<?php echo e($taxes_data->rate); ?>" required>
                     </div>
                  </div>
                  <div>
...
<?php echo $__env->make('admin.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bookfactory\resources\views\admin\localization\edittax.blade.php ENDPATH**/ ?>