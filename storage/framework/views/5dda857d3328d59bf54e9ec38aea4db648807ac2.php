                ...
                <div class="col-lg-12 ban col-md-12">
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="card">
                            ...
                            <form id="imageUploadForm" action="<?php echo e(url('admin/right_data')); ?>" enctype="multipart/form-data" method="post">
...
<?php echo $__env->make('admin.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ao0bylx163io/public_html/demo.aximoinfotech.com/bookfactory/bookfactoryworking/resources/views/admin/slider/edit_slider_right.blade.php ENDPATH**/ ?>