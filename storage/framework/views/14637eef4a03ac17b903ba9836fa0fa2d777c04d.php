...
<html class="no-js" lang="en">
   <head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
      ...
      <link rel="shortcut icon" href="<?php echo e(asset('public/webpages/assets/image/favicon.png')); ?>">
      ...
      <link rel="stylesheet" href="<?php echo e(asset('public/admin/assets/css/style.css').'?v=2'); ?>">
      <?php else: ?>
      ...
      <aside id="left-panel" class="left-panel">
         <nav class="navbar navbar-expand-sm navbar-default">
            <div class="navbar-header">
               ...
               <!-- <img src="<?php echo e(asset('public/admin/images/albamartnew.png')); ?>" alt="" style="width: 100px;">  -->
               </a>
               ...
               <ul class="nav navbar-nav">
                  ...
                  <li class="menu-item-has-children dropdown">
                     ...
                     <ul class="sub-menu children dropdown-menu">
                        ...
                        <li>
                           <a href="<?php echo e(url('admin/bestseller')); ?>">
                           <?php echo e(__('Best Seller')); ?>

                           </a>
                        </li>
                        <li>
                           <a href="<?php echo e(url('admin/dealofday')); ?>">
                           <?php echo e(__('Deal of Day')); ?>
                 ...
                 <?php endif; ?>
                  ...
                  <li>
                     <a href="vender" aria-haspopup="true" aria-expanded="false"> 
                     <i class="menu-icon  fa fa-users"></i>
                     <?php echo e(__('messages.vender')); ?>
                  ...
                  <li class="menu-item-has-children dropdown">
                     ...
                     <ul class="sub-menu children dropdown-menu">
                        ...
                        <li>
                        <a href="<?php echo e(url('admin/promobanner')); ?>">
                           <?php echo e(__('Promotion Section')); ?>
                           ...
                           <li>
                           <a href="<?php echo e(url('admin/showslider')); ?>">
                           <?php echo e(__('messages.slider')); ?>

                           </a>
                           </li>
                        <li> 
                           <a href="<?php echo e(url('admin/showslider2')); ?>">
                           <?php echo e(__('messages.sliderL')); ?>
                  ...
                  <li class="menu-item-has-children dropdown">
                     ...
                     <ul class="sub-menu children dropdown-menu">
                        ...
                        <li>
                           <a href="<?php echo e(url('admin/contactlist')); ?>">
                           <?php echo e(__('messages.contact')); ?>

                           </a>
                        </li>
                        <li>
                           <a href="<?php echo e(url('admin/requestlist')); ?>">
                           <?php echo e(__('messages.request')); ?>
                  ...
                  <!-- <li class="menu-item-has-children dropdown">
                     ...
                     <ul class="sub-menu children dropdown-menu">
                        <li>
                           <a href="<?php echo e(url('admin/vender')); ?>">
                           <?php echo e(__('messages.form')); ?>
                  ...
                  <li class="active">
                     <a href="<?php echo e(url('admin/author')); ?>"  aria-haspopup="true" aria-expanded="false"> 
                         <i class="menu-icon  fa fa-dollar"></i>
                         <?php echo e(__('Add Author')); ?>

                     </a>                     
                  </li> 
                  <li class="active">
                     <a href="<?php echo e(url('admin/publisher')); ?>"  aria-haspopup="true" aria-expanded="false"> 
                         <i class="menu-icon  fa fa-dollar"></i>
                         <?php echo e(__('Add Publisher')); ?>
                  ...
                  <li class="active">
                     <a href="<?php echo e(url('admin/report')); ?>"  aria-haspopup="true" aria-expanded="false" >
                  ...
                  <!-- <li class="active">
                     <a href="<?php echo e(url('admin/report')); ?>"  aria-haspopup="true" aria-expanded="false" >
                     <i class="menu-icon fa fa-bar-chart"></i>
                     <?php echo e(__('messages.report_product')); ?>
  ...
  <div class="dropdown-menu" aria-labelledby="bell-button" id="notificationshow">
   <p class="red" id="notificationmsg"><?php echo e(__('messages.orders_pending')); ?></p>
      ...
      <script type="text/javascript" src="<?php echo e(asset('public/js/admin.js').'?v=32423432'); ?>"></script>
      <script src='https://cdnjs.cloudflare.com/ajax/libs/selectize.js/0.12.1/js/standalone/selectize.js'></script>
      <?php echo $__env->yieldContent('footer'); ?>
   </body>
</html>
<?php /**PATH C:\xampp\htdocs\latestbook\resources\views/admin/index.blade.php ENDPATH**/ ?>