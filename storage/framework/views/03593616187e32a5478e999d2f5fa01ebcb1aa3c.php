...
<body>
    <div class="site-wrapper" id="top">
        ...
        <main class="inner-page-sec-padding-bottom">
            <div class=" my-container container" style="background-color:#fff" >
                <div class="row">
                                ...
                                <div class="product-card">
                                    <div class="product-grid-content">
                                        <!-- <div class="product-header">
                                            ...
                                            <h3><a href="<?php echo e(url('product-details')); ?>">Here Is A Quick Cure For Book</a>
                                            </h3>
                                        </div> -->
                                        <div class="product-card--body">
                                        <?php $__currentLoopData = $result; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Pd): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="card-image">
                                                ...
                                                <div class="hover-contents">
                                                    <a href="<?php echo e(url('productdetails')); ?>/<?php echo e($Pd->id); ?>" class="hover-image">
                                            ...
                                            <div class="border-bottom p-result-bottom">
                                                <h6 class="product-title mt-2 mb-1"><?php echo e($Pd->name); ?></h6>
                                                <p class="mb-1">by K Bhyrappa (Author)</p>
                                                <div class="rating-widget df-row-ss">
                                                    ...
                                                    <span class="rating-number">(832)</span>
                                                </div>
                                                <h4 class="product-title mt-2 mb-3 price-r-p">₹<?php echo e($Pd->price); ?></h4>
                                                <button class="checkout-btn c-btn pt-1 pb-1 btn--primary w-100"> <i class="fas fa-cart-plus"></i> Add to cart</button>
                                            </div>
                                    ...
                                    <div class="product-list-content">
                                        ...
                                        <div class="product-card--body">
                                            <div class="product-header">
                                                ...
                                                <h3><a href="<?php echo e(url('product-details')); ?>" tabindex="0">
                                                Swami Vivekananda</a></h3>
                                                        <p class="mb-1">by K Bhyrappa (Author)</p>
                                            </div>
                                            <article>
                                            ...
                                            <h4 class="product-title mt-2 mb-0 price-r-p ">₹2738</h4>
                                            </div>
                                            <div class="rating-widget df-row-ss mt-2">
                                                    <div class="rating-block">
                                                        <span class="fas fa-star star_on"></span>
                                                        <span class="fas fa-star star_on"></span>
                                                        <span class="fas fa-star star_on"></span>
                                ...
                                <div class="product-card">
                                    <div class="product-grid-content">
                                        ...
                                        <div class="product-card--body">
                                            ...
                                            <div class="border-bottom p-result-bottom">
                                                <h6 class="product-title mt-2 mb-1">Swami Vivekananda</h6>
                                                <p class="mb-1">by K Bhyrappa (Author)</p>
                                                <div class="rating-widget df-row-ss">
                                                    <div class="rating-block">
                                                        <span class="fas fa-star star_on"></span>
                                                ...
                                                <h4 class="product-title mt-2 mb-3 price-r-p">₹2738</h4>
                                                <button class="checkout-btn c-btn pt-1 pb-1 btn--primary w-100"> <i class="fas fa-cart-plus"></i> Add to cart</button>
                                            </div>
                        ...
                        <div class="inner-page-sidebar">
                            ...
                            <!-- <div class="single-block">
								<a href="" class="promo-image sidebar">
									<img src="<?php echo e(asset('public/webpages/assets/image/others/home-side-promo.jpg')); ?>" alt="">
								</a>
							</div> -->
                        </div>
                    </div>
...
</html><?php /**PATH C:\xampp\htdocs\bookfactory latest rahul\resources\views/webpages/result.blade.php ENDPATH**/ ?>