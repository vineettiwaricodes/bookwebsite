                ...
                <div class="breadcrumb-contents">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">bookfactory journals</li>
                        </ol>
                    </nav>
                </div>
            </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-12">
                        <div class="contact_adress">
                            <div class="ct_address">
                                <h3 class="ct_title">About bookfactory journals</h3>
                            ...
                            <div class="address_wrapper">
                                <div class="address">
                                    ...
                                    <div class="contact-info-text">
                                        <p><span>Address:</span>Rjat Vihar,Sector 62A,Noida(U.P)</p>
                                    </div>
                                </div>
                                <div class="address">
                                    <div class="icon">
...
</html><?php /**PATH /home/ao0bylx163io/public_html/demo.aximoinfotech.com/bookfactory/bookfactoryworking/resources/views/webpages/bookfactory-journals.blade.php ENDPATH**/ ?>