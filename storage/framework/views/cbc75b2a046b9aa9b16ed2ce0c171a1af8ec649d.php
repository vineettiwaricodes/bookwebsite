...
<html class="no-js" lang="en">
   <head>
      ...
      <link rel="stylesheet" href="<?php echo e(url('admin/vendors/bootstrap/dist/css/bootstrap.min.css')); ?>">
      <link rel="stylesheet" href="<?php echo e(url('admin/vendors/font-awesome/css/font-awesome.min.css')); ?>">
      <link rel="stylesheet" href="<?php echo e(url('admin/vendors/themify-icons/css/themify-icons.css')); ?>">
      <link rel="stylesheet" href="<?php echo e(url('admin/vendors/flag-icon-css/css/flag-icon.min.css')); ?>">
      <link rel="stylesheet" href="<?php echo e(url('admin/vendors/selectFX/css/cs-skin-elastic.css')); ?>">
...
</html><?php /**PATH C:\xampp\htdocs\bookfactory\resources\views\email\admin\login.blade.php ENDPATH**/ ?>