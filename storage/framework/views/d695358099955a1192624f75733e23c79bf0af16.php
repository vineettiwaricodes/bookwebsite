                           ...
                           <div class="custom-tab">
                              <nav class="col-md-12 tabcatlog">
                                 <div class="nav nav-tabs tabdiv" id="nav-tab" role="tablist">
                                    ...
                                    <a class="nav-item nav-link <?= $tab==4?"active":"tabdiv" ?>" id="custom-nav-shipping-tab" data-toggle="tab" href="#custom-nav-shipping" role="tab" aria-controls="custom-nav-shipping" aria-selected="false"><?php echo e(__('Shipping Cost')); ?></a>
                                    <a class="nav-item nav-link <?= $tab==5?"active":"tabdiv" ?>" id="custom-nav-delivery-tab" data-toggle="tab" href="#custom-nav-delivery" role="tab" aria-controls="custom-nav-delivery" aria-selected="false"><?php echo e(__('Delivery Days')); ?></a>
                                    <a class="nav-item nav-link <?= $tab==6?"active":"tabdiv" ?>" id="custom-nav-inventory-tab" data-toggle="tab" href="#custom-nav-inventory" role="tab" aria-controls="custom-nav-inventory" aria-selected="false"><?php echo e(__('messages.inventory')); ?></a>
                                    <a class="nav-item nav-link <?= $tab==7?"active":"tabdiv" ?>" id="custom-nav-imgls-tab" data-toggle="tab" href="#custom-nav-imgls" role="tab" aria-controls="custom-nav-imgls" aria-selected="false"><?php echo e(__('messages.images')); ?></a>
                                    <a class="nav-item nav-link <?= $tab==8?"active":"tabdiv" ?>" id="custom-nav-attribute-tab" data-toggle="tab" href="#custom-nav-attribute" role="tab" aria-controls="custom-nav-attribute" aria-selected="true"><?php echo e(__('messages.attribute')); ?></a>
                                    <a class="nav-item nav-link <?= $tab==9?"active":"tabdiv" ?>" id="custom-nav-option-tab" data-toggle="tab" href="#custom-nav-option" role="tab" aria-controls="custom-nav-option" aria-selected="false"><?php echo e(__('messages.option')); ?></a>
                                    <a class="nav-item nav-link tabdiv <?= $tab==10?"active":"tabdiv" ?>" id="custom-nav-rel_pro-tab" data-toggle="tab" href="#custom-nav-rel_pro" role="tab" aria-controls="custom-nav-rel_pro" aria-selected="false"><?php echo e(__('messages.realted_product')); ?></a>     
                                 </div>
                              </nav>
                              <div class="tab-content col-md-12 p-0 " id="nav-tabContent">
                                 <div class="tab-pane fade <?= $tab==1?"show active":"" ?> pd10" id="custom-nav-general" role="tabpanel" aria-labelledby="custom-nav-general-tab" >
                                    ...
                                    <form action="<?php echo e(url('admin/saveproduct')); ?>" method="post">
                                       ...
                                       <div class="row">
                                          ...
                                          <div class="form-group col-md-4">
                                             <label for="subcategory" class="control-label mb-1"><?php echo e(__('messages.sub_cat')); ?>
                                          ...
                                          <div class="form-group  col-md-4" >
                                             <label for="brand" class="control-label mb-1"><?php echo e(__('messages.brands')); ?>
                                          ...
                                          <div class="form-group col-md-6" >
                                             <label for="brand" class="control-label mb-1"><?php echo e(__('ISBN')); ?><span class="reqfield">*</span>
                                             </label>
                                          ...
                                          <div class="form-group col-md-6" >
                                             <label for="brand" class="control-label mb-1"><?php echo e(__('Dimension(H-L-W)')); ?>
                                 ...
                                 <div class="tab-pane fade <?= $tab==4?"show active":"" ?> pd10" id="custom-nav-shipping" role="tabpanel" aria-labelledby="custom-nav-shipping-tab" >
                                    <h3><?php echo e(__('Shipping Cost')); ?></h3>
                                    <div class="tabdivcatlog"></div>
                                    <form action="<?php echo e(url('admin/saveshippingcharges')); ?>" method="post">
                                       <?php echo e(csrf_field()); ?>

                                       <input type="hidden" name="product_id" id="product1" value
                                       ="<?php echo e($product_id); ?>"/>
                                       <div class="form-group">
                                          <label for="name" class="control-label mb-1"><?php echo e(__('Shipping Charges')); ?><span class="reqfield">*</span>
                                          </label>
                                          <input id="shipping_charges" name="shipping_charges" value="<?= isset($data->shipping_charges)?$data->shipping_charges:""?>" type="text" class="form-control" aria-required="true" aria-invalid="false" placeholder="<?php echo e(__('shipping charges')); ?>" required>
                                       </div>
                                       <div class="row form-group rowset">
                                          <button class="btn btn-primary btn-flat m-b-30 m-t-30 florig" type="submit"><?php echo e(__('messages.save')); ?></button>
                                       </div>
                                 ...
                                 <div class="tab-pane fade <?= $tab==5?"show active":"" ?> pd10" id="custom-nav-delivery" role="tabpanel" aria-labelledby="custom-nav-delivery-tab" >
                                    <h3><?php echo e(__('Delivery Charges')); ?></h3>
                                    <div class="tabdivcatlog"></div>
                                    <form action="<?php echo e(url('admin/savedeliverycharges')); ?>" method="post">
                                       <?php echo e(csrf_field()); ?>

                                       <input type="hidden" name="product_id" id="product1" value
                                       ="<?php echo e($product_id); ?>"/>
                                       <div class="form-group">
                                          <label for="name" class="control-label mb-1"><?php echo e(__('Delivery Days')); ?><span class="reqfield">*</span>
                                          </label>
                                          <input id="delivery_days" name="delivery_days" value="<?= isset($data->delivery_days)?$data->delivery_days:""?>" type="text" class="form-control" aria-required="true" aria-invalid="false" placeholder="<?php echo e(__('delivery charges')); ?>" required>
                                       </div>
                                       <div class="row form-group rowset">
                                          <button class="btn btn-primary btn-flat m-b-30 m-t-30 florig" type="submit"><?php echo e(__('messages.save')); ?></button>
                                       </div>
                                 ...
                                 <div class="tab-pane fade <?= $tab==6?"show active":"" ?> pd10" id="custom-nav-inventory" role="tabpanel" aria-labelledby="custom-nav-inventory-tab">
                                    ...
                                    <form action="<?php echo e(url('admin/saveinventory')); ?>" method='post'>
                                       ...
                                       <div class="row">
                                          <div class="form-group col-md-4">
                                             <label for="name" class="control-label mb-1"><?php echo e(__('messages.SKU')); ?><span class="reqfield">*</span></label>
                                             <input id="sku" name="sku" type="text" value="<?= isset($data->sku)?$data->sku:""?>" class="form-control" aria-invalid="false" placeholder="<?php echo e(__('messages.SKU')); ?>" required>
                                          </div>
                                          <div class="form-group col-md-4">
                                             <label for="name" class="control-label mb-1"><?php echo e(__('Quantity')); ?></label>
                                             <input id="sku" name="quantity" type="number" value="<?= isset($data->quantity)?$data->quantity:""?>" class="form-control" aria-invalid="false" placeholder="<?php echo e(__('Quantity')); ?>">
                                          </div>
                                          <div class="form-group col-md-4">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\latestbook\resources\views/admin/product/addproduct.blade.php ENDPATH**/ ?>