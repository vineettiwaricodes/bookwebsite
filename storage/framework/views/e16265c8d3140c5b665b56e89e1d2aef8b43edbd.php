...
<html class="no-js" lang="en">
   <head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
      ...
      <link rel="shortcut icon" href="<?php echo e(asset('public/upload/favicon.ico')); ?>">
      ...
      <link rel="stylesheet" href="<?php echo e(asset('admin/assets/css/style.css').'?v=2'); ?>">
      <?php else: ?>
       <link rel="stylesheet" href="<?php echo e(asset('admin/assets/css/Rtl.css').'?v=2'); ?>">
      <?php endif; ?>
     
      <link href='https://fonts.googleapis.com/css?family=Open+Sans:400,600,700,800' rel='stylesheet' type='text/css'>
      <link rel="stylesheet" href="<?php echo e(asset('admin/vendors/chosen/chosen.min.css')); ?>">
  ...
  <div class="dropdown-menu" aria-labelledby="bell-button" id="notificationshow">
   <p class="red" id="notificationmsg"><?php echo e(__('messages.orders_pending')); ?></p>
      ...
      <script src="<?php echo e(asset('admin/vendors/popper.js/dist/umd/popper.min.js')); ?>"></script>
      ...
      <script src="<?php echo e(asset('admin/vendors/chosen/chosen.jquery.min.js')); ?>"></script>
      ...
      <script type="text/javascript" src="<?php echo e(asset('public/js/admin.js').'?v=522265465'); ?>"></script>
      <script src='https://cdnjs.cloudflare.com/ajax/libs/selectize.js/0.12.1/js/standalone/selectize.js'></script>
      <?php echo $__env->yieldContent('footer'); ?>
   </body>
</html><?php /**PATH C:\xampp\htdocs\bookfactory\resources\views\email\admin\index.blade.php ENDPATH**/ ?>