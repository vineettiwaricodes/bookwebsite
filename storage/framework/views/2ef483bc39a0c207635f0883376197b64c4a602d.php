                     ...
                     <div id="pay-invoice">
                        <div class="card-body">
                           ...
                           <div class="row form-group">
                              ...
                              <div class="col-12 col-md-9">
                                 <input type="number" id="rate" step="any" placeholder="<?php echo e(__('messages.rate')); ?>" class="form-control" name="rate" required>
                              </div>
                           </div>
                           <div>
...
<?php echo $__env->make('admin.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bookfactory\resources\views\admin\localization\addtaxes.blade.php ENDPATH**/ ?>