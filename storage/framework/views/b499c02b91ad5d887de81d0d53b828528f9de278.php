                ...
                <div class="col-lg-12 ban col-md-12">
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="card">
                            ...
                            <form id="imageUploadForm" action="<?php echo e(url('admin/addslider')); ?>" enctype="multipart/form-data" method="post">
                  ...
                  <table  class="table table-striped table-bordered dttablewidth">
                     ...
                     <?php $__currentLoopData = $Slider; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cd): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <td><?php echo e($cd->urllink); ?></td>
                         ...
                         <td><a onclick="return confirm('Are you sure?')" href='delete/<?php echo e($cd->id); ?>'> <i class="fa fa-trash f-s-25" style="font-size: x-large; "></i> </a>
                          <a   onclick="return confirm('Are you sure?')" href='edit_right/<?php echo e($cd->id); ?>'> <i class="fa fa-edit f-s-25" style="font-size: x-large;"></i> </a></td>
...
<?php echo $__env->make('admin.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ao0bylx163io/public_html/demo.aximoinfotech.com/bookfactory/bookfactoryworking/resources/views/admin/slider/slider.blade.php ENDPATH**/ ?>