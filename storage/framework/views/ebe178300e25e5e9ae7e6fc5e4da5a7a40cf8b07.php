                ...
                <div class="row mt-60 ">
                    <div class="col-lg-6 col-md-6 col-12">
                       ...
                       <?php echo e(session('message')); ?>
                             ...
                             <?php endif; ?>
                            <form  action="<?php echo e(url('storecontact')); ?>" method="post"   class="contact-form">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <labal style="color: red;" ><?php echo e($errors->first('name')); ?> </labal>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <labal style="color: red;" ><?php echo e($errors->first('email')); ?> </labal>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <labal style="color: red;" ><?php echo e($errors->first('phone')); ?> </labal>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <labal style="color: red;" ><?php echo e($errors->first('subject')); ?> </labal>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <labal style="color: red;" ><?php echo e($errors->first('message')); ?> </labal>
                    ...
                    <div class=""><img src="<?php echo e(asset('public/webpages/assets/image/contact-image.png')); ?>" alt=""> </div>
...
</html><?php /**PATH /home/ao0bylx163io/public_html/demo.aximoinfotech.com/bookfactory/bookfactoryworking/resources/views/webpages/contact.blade.php ENDPATH**/ ?>