                        ...
                        <div class="card-body">
                            ...
                            <form action="<?php echo e(url('admin/storeofferdata')); ?>" method="post" enctype="multipart/form-data">
                                ...
                                <?php if($offer_type==1): ?>
                                    ...
                                    <?php if($offer_type==1): ?>
                                       <input type="file" id="mobile_banner" class="form-control" name="mobile_banner" required>
                                    <?php else: ?>
...
<?php echo $__env->make('admin.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bookfactory\resources\views\email\admin\offer\offeradd.blade.php ENDPATH**/ ?>