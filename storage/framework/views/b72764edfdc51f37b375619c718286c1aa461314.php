                        ...
                        <table id="bigofferTable" class="table table-striped table-bordered dttablewidth">
                            <thead>
                                <tr>
                                    ...
                                    <th class="title-name"><?php echo e(__('messages.title')); ?></th>
                                    <th><?php echo e(__('messages.date')); ?></th>
                                    <th><?php echo e(__('messages.offer_on')); ?></th>
                                    <th class="off-name"><?php echo e(__('messages.name')); ?></th>
...
<?php echo $__env->make('admin.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bookfactory\resources\views\email\admin\offer\default.blade.php ENDPATH**/ ?>