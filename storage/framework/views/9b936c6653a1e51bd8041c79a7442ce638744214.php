               ...
               <div class="modal-body">
                  ...
                  <div class="form-group col-md-12 paddiv">
                     <div class="col-md-6">
                        ...
                        <input id="email" name="email" type="text" class="form-control" readonly="" placeholder="<?php echo e(__('messages.email')); ?>">
                     </div>
                     <div class="col-md-6">
...
<?php echo $__env->make('admin.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bookfactory\resources\views\email\admin\user\admin.blade.php ENDPATH**/ ?>