...
$(document).ready(function() {
        ...
        $(document).ready(function() {
            $('#bestsellertable').DataTable({
                processing: true,
                serverSide: true,
                ajax: $("#url_path").val()+'/admin/bestsellerdatatable',
                columns: [{
                    data: 'id',
                    name: 'id'
                }, {
        ...
        $(document).ready(function() {
            $('#dealofdaytable').DataTable({
                processing: true,
                serverSide: true,
                ajax: $("#url_path").val()+'/admin/dealofdaydatatable',
                columns: [{
                    data: 'id',
                    name: 'id'
                }, {
 ...
 $(document).ready(function () {
   ...
   $(document).ready(function () {
    ...
    $('#venderTable').DataTable({
       processing: true,
       serverSide: true,
       ajax: $("#url_path").val()+'/admin/vendordatatable',
       columns: [
         {data: 'id'    , name: 'id'},
         {data: 'name'  , name: 'name'},
         {data: 'email'  , name: 'email'},
...
$(document).ready(function () {
    ...
    $('#blogTable').DataTable({
       processing: true,
       serverSide: true,
       ajax: $("#url_path").val()+'/admin/blogdatatable',
       columns: [
         {data: 'id'    , name: 'id'},
         {data: 'title'  , name: 'title'},
         {data: 'description'  , name: 'description'},
...
$(document).ready(function () {
    ...
    $('#authorTable').DataTable({
       processing: true,
       serverSide: true,
       ajax: $("#url_path").val()+'/admin/authordatatable',
       columns: [
         {data: 'id'    , name: 'id'},
         {data: 'name'  , name: 'name'},
         {data:'image', name: 'image'},
...
$(document).ready(function () {
    ...
    $('#publisherTable').DataTable({
       processing: true,
       serverSide: true,
       ajax: $("#url_path").val()+'/admin/publisherdatatable',
       columns: [
         {data: 'id'    , name: 'id'},
         {data: 'name'  , name: 'name'},
         {data:'image', name: 'image'},
...
function editvender(id){
    $.ajax( {
                  url: $("#url_path").val()+"/admin/editvender"+"/"+id,
                  data: { },
                  success: function( str ) {
                ...
                function editblog(id){
                  $.ajax( {
                  url: $("#url_path").val()+"/admin/editblog"+"/"+id,
                  data: { },
                  success: function( str ) {
                    ...
                    var data=JSON.parse(str);
                      ...
                      $("#edit-meta_title").val(data.meta_title);
                      $("#edit-description").val(data.description);
                      $("#edit-meta_keyword").val(data.meta_keyword);
            ...
            function editpublisher(id){
                $.ajax( {
                url: $("#url_path").val()+"/admin/editpublisher"+"/"+id,
                data: { },
                success: function( str ) {
              ...
              function viewblog(id){
                $.ajax( {
                url: $("#url_path").val()+"/admin/previewblog"+"/"+id,
                data: { },
        ...
        function previewproduct(id){
            $.ajax( {
            url: $("#url_path").val()+"/admin/previewproduct"+"/"+id,
            data: { },
            ...
            success: function( str ) {
             var data=JSON.parse(str);
              console.log(data);
              $('#name').text(data.name);
              $('#vender_name').text(data.vender_name);
              $('#author').text(data.author);
              $('#language').text(data.language);
              $('#publisher').text(data.publisher);
              $('#isbn').text(data.isbn);
              $('#binding').text(data.binding);
              $('#print').text(data.print_on_demand);
            }
...
function edituser(id){
   ...
   function editauthor(id){
    $.ajax( {
                  url: $("#url_path").val()+"/admin/editauthor"+"/"+id,
                  data: { },
                  success: function( str ) {
                    var data=JSON.parse(str);
                    console.log(data);
