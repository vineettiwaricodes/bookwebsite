jQuery(document).ready(function($) {
    (function($) {
        ...
        function categoryMenuExpand() {
            ...
            $(".js-expand-hidden-menu").on('click', function(e) {
                ...
                $(this).php($(this).text() == htmlAfter ? htmlBefore : htmlAfter);
        ...
        $('#category-trigger-hb').on('click', function(e) {
            $('#category-nav-hb').toggleClass('show');
            e.stopPropagation();
        })

        $('#category-trigger-hm').on('click', function(e) {
            $('#category-nav-hm').toggleClass('show');
            e.stopPropagation();
        })
        $('#category-trigger-sticky').on('click', function(e) {
            $('#category-nav-sticky').toggleClass('show');
            e.stopPropagation();
        })
    ...
    $('[data-countdown]').each(function() {
        ...
        $this.countdown(finalDate, function(event) {
            $this.php(event.strftime('<div class="single-countdown"><span class="single-countdown__time">%D</span><span class="single-countdown__text">Days</span></div><div class="single-countdown"><span class="single-countdown__time">%H</span><span class="single-countdown__text">Hours</span></div><div class="single-countdown"><span class="single-countdown__time">%M</span><span class="single-countdown__text">mins</span></div><div class="single-countdown"><span class="single-countdown__time">%S</span><span class="single-countdown__text">Secs</span></div>'));
        });
    });
